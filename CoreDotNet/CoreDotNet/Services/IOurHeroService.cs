...
namespace CoreDotNet.Services
{
    public interface IOurHeroService
    {
        ...
        OurHero AddOurHero(OurHero obj);

        OurHero? UpdateOurHero(int id, OurHero obj);
    ...
    public class OurHeroService : IOurHeroService
    {
        ...
        public OurHero AddOurHero(OurHero obj)
        {
        ...
        public OurHero? UpdateOurHero(int id, OurHero obj)
        {
